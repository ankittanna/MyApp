...
function Tutorial5(scene) {
    ...
    THREE.ImageUtils.loadTexture('images/Tut5.png', undefined, function (texture) {
        ...
        document.getElementById('tut5BoxLeft').innerHTML = "<p>Look Up to go to IIR</p><p class='redText'>Focus on Image to go to next step</p>";
        document.getElementById('tut5BoxRight').innerHTML = "<p>Look Up to go to IIR</p><p class='redText'>Focus on Image to go to next step</p>";
