...
function Tutorial3(scene) {
    ...
    THREE.ImageUtils.loadTexture('images/Tut3.png', undefined, function (texture) {
        ...
        document.getElementById('tut3BoxLeft').innerHTML = "<p>Look for the red arrow in the room.</p> <p class='redText'>Focus on it to move to next room.</p>";
        document.getElementById('tut3BoxRight').innerHTML = "<p>Look for the red arrow in the room.</p> <p class='redText'>Focus on it to move to next room.</p>";
