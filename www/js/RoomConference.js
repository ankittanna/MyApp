...
function RoomConference(scene) {
    ...
    conferenceRoomNotificationLeft.innerHTML = "NOTIFICATION";
    ...
    conferenceRoomNotificationRight.innerHTML = "NOTIFICATION";
    ...
    rotateHeadNotificationLeft.innerHTML = "Look around 360°. Focus on Play Button to view the Demo";
    ...
    rotateHeadNotificationRight.innerHTML = "Look around 360°. Focus on Play Button to view the Demo";
    ...
    setInterval(function () {
        ...
        if (connectionFlag && room.liveStream == undefined) {
            ...
            THREE.ImageUtils.loadTexture('images/live-Green.png', undefined, function (texture) {
                ...
                conferenceRoomNotificationLeft.innerHTML = "IIR Live Stream Available. Focus on Green On-Air logo to watch the Live Stream.";
                conferenceRoomNotificationRight.innerHTML = "IIR Live Stream Available. Focus on Green On-Air logo to watch the Live Stream.";
