...
function Tutorial2(scene) {
    ...
    THREE.ImageUtils.loadTexture('images/Tut2.png', undefined, function (texture) {
        ...
        document.getElementById('tut2BoxLeft').innerHTML = "<p>360° View</p> <p class='redText'>Focus on the Images to go to next step.</p>";
        document.getElementById('tut2BoxRight').innerHTML = "<p>360° View</p> <p class='redText'>Focus on the Images to go to next step.</p>";
